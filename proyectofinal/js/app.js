...
function mostrarProductos() {
    alert("Bienvenido a la tienda de River Plate, nuestros productos son los siguientes")
...
function comprar() {
    ...
    while (compra !== 0) {
        ...
        compra = Number(prompt("Elija el producto que quiera: 1-camiseta titular, 2-camiseta suplente, 3-short titular, 4-short suplente, 5-camiseta de arquero, 6-gorra o 0-salir"))
